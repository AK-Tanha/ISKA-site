...
export function Hero() {
  return (
    <section className="relative min-h-[90vh] flex items-center overflow-hidden bg-iska-black">
      ...
      <div className="container-custom relative z-10 grid lg:grid-cols-2 gap-12 items-center pt-6 pb-12">
        <motion.div
        ...
        >
          ...
          <h1 className="text-3xl sm:text-4xl md:text-7xl font-display font-bold text-white leading-[1.1] tracking-tighter">
          ...
          <div className="flex flex-wrap gap-4 pt-2">
            <a href="/about" className="btn-primary flex items-center gap-2 text-sm sm:text-lg">
        ...
        >
          <div className="relative z-10 bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 shadow-2xl">
            <div className="flex items-center gap-6 mb-12">
              <div className="w-20 h-20 bg-white rounded-full flex items-center justify-center shadow-lg overflow-hidden relative">
                <Image 
              ...
              <div>
                <h3 className="text-white font-display font-bold text-xl sm:text-2xl">ISKA Bangladesh</h3>
            ...
            <div className="mt-12 pt-8 border-t border-white/10 flex justify-between items-center">
              <div className="flex -space-x-3">
                {[1,2,3,4].map(i => (
                  <div key={i} className="w-10 h-10 rounded-full border-2 border-iska-black bg-gray-800 flex items-center justify-center overflow-hidden relative">
                    <Image src={`https://i.pravatar.cc/100?u=${i}`} alt="Avatar" fill className="object-cover" sizes="40px" />
                  </div>
                ))}
  ...
  return (
    <div className={`space-y-3 sm:space-y-4 mb-6 sm:mb-10 ${centered ? 'text-center mx-auto' : ''} ${centered ? 'max-w-2xl' : ''}`}>
      ...
      >
        ...
        {subtitle && (
          <p className={`text-base sm:text-lg mt-2 sm:mt-4 leading-relaxed ${dark ? 'text-gray-400' : 'text-gray-600'}`}>
            {subtitle}
          </p>
        )}
      </motion.div>
