    ...
    <main className="min-h-screen bg-white">
      ...
      <section className="section-padding">
        <div className="container-custom">
            ...
            {REGIONS.map((region, idx) => (
              <div key={idx} className="group p-8 rounded-2xl border border-gray-100 bg-gray-50/50 hover:bg-white hover:shadow-2xl hover:shadow-iska-blue/10 transition-all duration-500">
                <div className="flex items-center gap-3 mb-6 text-iska-blue">
                  ...
                  <h3 className="text-lg sm:text-xl font-display font-bold">{region.name} Region</h3>
                </div>
                ...
                <div className="space-y-4">
                  <div className="py-12 border-2 border-dashed border-gray-200 rounded-xl flex flex-col items-center justify-center text-gray-400 relative overflow-hidden group/pending">
                    <Image 
                      src={`https://picsum.photos/seed/${region.name.toLowerCase()}-placeholder/400/400`}
                      alt="Pending Appointment"
                      fill
                      className="object-cover opacity-20 transition-all duration-700 group-hover/pending:scale-110"
          ...
          <div className="mt-24 p-8 sm:p-12 bg-iska-blue rounded-3xl text-white relative overflow-hidden shadow-2xl">
            <div className="relative z-10 max-w-2xl">
              <h2 className="text-lg sm:text-xl font-display font-bold mb-6 tracking-tighter">Become a Regional Leader</h2>
              <p className="text-iska-blue-light text-base sm:text-lg mb-8 leading-relaxed">
